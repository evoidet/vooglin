...
const binaryAssetDefinitions = [
  ...
  { url: "/favicon.ico", filename: "vooglin-v-black.ico", outputFilename: "favicon.ico", type: "image/x-icon" },
  { url: "/favicon-48x48.png", filename: "vooglin-v-black-48x48.png", outputFilename: "favicon-48x48.png", type: "image/png" },
  { url: "/favicon-96x96.png", filename: "vooglin-v-black-96x96.png", outputFilename: "favicon-96x96.png", type: "image/png" },
  { url: "/favicon-192x192.png", filename: "vooglin-v-black-192x192.png", outputFilename: "favicon-192x192.png", type: "image/png" },
  { url: "/favicon-512x512.png", filename: "vooglin-v-black.png", outputFilename: "favicon-512x512.png", type: "image/png" },
  { url: "/apple-touch-icon.png", filename: "vooglin-v-black-apple-touch-icon.png", outputFilename: "apple-touch-icon.png", type: "image/png" },
  { url: "/vooglin-organization-logo.png", filename: "vooglin-v-black-organization-logo.png", outputFilename: "vooglin-organization-logo.png", type: "image/png" },
