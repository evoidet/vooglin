...
- The current year, mobile navigation, booking dialog, calculator, animated client count and motion, split-scroll story, reveal effects and reusable background systems are handled in `script.js`.
