const translations = {
  et: {
    ...
    home: [
      ...
      ["Generate personalised emails, PDFs, certificates and organised records from the same data.", "Loome samadest andmetest personaalsed e-kirjad, PDF-id, tunnistused ja korrastatud kirjed."],
    ...
    pricing: [
      ["Pricing — Clear scope and fixed quotes | Vooglin", "Hinnad — Selge ulatus ja fikseeritud pakkumine | Vooglin"],
      ...
      ["Clear scope. Fixed price before we build.", "Selge ulatus. Fikseeritud hind enne ehitamist."],
      ...
      ["Clear scope.<br>Fixed price before we build.", "Selge ulatus.<br>Fikseeritud hind enne ehitamist."],
      ["Every project starts with a short review of the work, tools and desired result. You receive a written scope, delivery plan and fixed quote before any build begins.", "Iga projekt algab töö, tööriistade ja soovitud tulemuse lühikese ülevaatusega. Enne ehitamist saad kirjaliku ulatuse, teostusplaani ja fikseeritud pakkumise."],
      ["Discuss your workflow", "Räägime sinu töövoost"],
      ["No open-ended build. No surprise invoice.", "Ei mingit määramata mahuga arendust. Ei mingeid üllatusarveid."],
      ...
      ["Fixed scope + implementation", "Fikseeritud ulatus + teostus"],
      ...
      ["Before the build", "Enne ehitamist"],
      ...
      ["Scope", "Ulatus"],
      ["We define what will be built, what access is required and what is outside the project.", "Määratleme, mida ehitatakse, millist ligipääsu on vaja ja mis jääb projektist välja."],
      ["Quote", "Pakkumine"],
      ["You receive the scope, delivery plan and fixed price in writing. Work begins only after you approve it.", "Saad ulatuse, teostusplaani ja fikseeritud hinna kirjalikult. Töö algab alles pärast sinu kinnitust."],
      ...
      ["Included", "Hinna sees"],
      ["A working system, clearly handed over.", "Toimiv süsteem, selgelt üle antud."],
      ["Agreed project scope", "Kokkulepitud projekti ulatus"],
      ...
      ["Fixes for anything that does not match the agreed scope", "Parandused kõigele, mis ei vasta kokkulepitud ulatusele"],
  ...
  ru: {
    ...
    home: [
      ...
      ["Vooglin builds practical automation and digital workflows for small organisations, project teams, and growing businesses.", "Vooglin создаёт практичные автоматизации и цифровые процессы для небольших организаций, проектных команд и растущего бизнеса."],
    ...
    pricing: [
      ...
      ["Clear scope. Fixed price before we build.", "Понятный объём. Фиксированная цена до начала работы."],
      ...
      ["Clear scope.<br>Fixed price before we build.", "Понятный объём.<br>Фиксированная цена до начала работы."],
      ...
      ["Discuss your workflow", "Обсудить ваш процесс"],
      ["No open-ended build. No surprise invoice.", "Никаких работ без границ. Никаких неожиданных счетов."],
      ...
      ["Included", "Включено"],
      ["A working system, clearly handed over.", "Работающая система с понятной передачей."],
