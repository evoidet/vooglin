const translations = {
  et: {
    ...
    home: [
      ...
      ["We could not send the request. Please try again or send it by email instead.", "Kohtumispäringut ei õnnestunud saata. Proovi uuesti või saada see e-postiga."],
      ["Send by email instead", "Saada selle asemel e-postiga"],
      ["Request received", "Päring vastu võetud"],
      ["Thank you. Your meeting request was sent.", "Aitäh. Sinu kohtumispäring on saadetud."],
      ["The meeting is not booked yet. Egor will confirm the date and time with you by email.", "Kohtumine ei ole veel broneeritud. Egor kinnitab kuupäeva ja kellaaja e-postiga."],
  ...
  ru: {
    ...
    home: [
      ...
      ["We could not send the request. Please try again or send it by email instead.", "Не удалось отправить запрос. Попробуйте ещё раз или отправьте его по электронной почте."],
      ["Send by email instead", "Отправить по электронной почте"],
      ["Request received", "Запрос получен"],
      ["Thank you. Your meeting request was sent.", "Спасибо. Ваш запрос на встречу отправлен."],
      ["The meeting is not booked yet. Egor will confirm the date and time with you by email.", "Встреча ещё не назначена. Егор подтвердит дату и время по электронной почте."],
