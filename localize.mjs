const translations = {
  et: {
    common: [
      ...
      ["Vooglin on LinkedIn (opens in a new tab)", "Vooglin LinkedInis (avaneb uuel vahelehel)"],
      ["Menu", "Menüü"],
      ["Close", "Sulge"],
  ...
  ru: {
    common: [
      ...
      ["Vooglin on LinkedIn (opens in a new tab)", "Vooglin в LinkedIn (откроется в новой вкладке)"],
      ["Menu", "Меню"],
      ["Close", "Закрыть"],
